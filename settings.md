...
- [Settings](#settings)
  - [Install the LTS kernel](#install-the-lts-kernel)
  - [Enable numlock on start](#enable-numlock-on-start)
  - [Automount drives](#automount-drives)
  - [Auto hide cursor](#auto-hide-cursor)
  - [Synchronize clock](#synchronize-clock)
  - [Enable auto login in tty](#enable-auto-login-in-tty)
  - [Auto start x](#auto-start-x)
  - [Enable hibernation](#enable-hibernation)
  - [Set up rclone to sync files with cloud](#set-up-rclone-to-sync-files-with-cloud)
  - [Install list of words for spell checker](#install-list-of-words-for-spell-checker)
  - [Customize GRUB](#customize-grub)
  - [Set up slock as a locker](#set-up-slock-as-a-locker)
  - [Set wallpaper as a solid color](#set-wallpaper-as-a-solid-color)
  - [Disable action when lid closes](#disable-action-when-lid-closes)
  - [Fix screen tearing](#fix-screen-tearing)
  - [Configure GTK and Qt themes](#configure-gtk-and-qt-themes)
    - [Change gtk theme on the fly](#change-gtk-theme-on-the-fly)
  - [Set up fish](#set-up-fish)
    - [Installation](#installation)
    - [Set fish as default shell](#set-fish-as-default-shell)
    - [Set up command completion](#set-up-command-completion)
    - [Remove fish greeting](#remove-fish-greeting)
    - [Enable vi mode](#enable-vi-mode)
    - [Fish config](#fish-config)
    - [Start x from fish](#start-x-from-fish)
  - [Emojis](#emojis)
